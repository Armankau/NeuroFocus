...
User_1 = User.create(name: "Armandeep Kaur", age: 21, username: "Arman", password: "password", email: "akaur@ucsd.edu", sex: "female", score:0, image: "https://www.dmarge.com/wp-content/uploads/2021/01/dwayne-the-rock-.jpg")
User_2 = User.create(name: "Rajdeep Kaur", age: 17, username: "Raj", password: "password", email: "akaur@ucsd.edu", sex: "female", score: 5, image: "https://cdn.shopify.com/s/files/1/0850/2114/files/tips_to_help_heighten_senses_480x480.png?v=1624399167")
